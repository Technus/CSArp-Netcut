...
public partial class ScannerForm : Form, IView
{
    ...
    public ToolStripStatusLabel ToolStripStatus => toolStripStatus;
    public ToolStripComboBox ToolStripComboBoxNetworkDeviceList => toolStripComboBoxDevicelist;
    public Form MainForm => this;
    public NotifyIcon NotifyIcon1 => notifyIcon1;
    public ToolStripTextBox ToolStripTextBoxClientName => toolStripTextBoxClientName;
    ...
    public ToolStripMenuItem ShowLogToolStripMenuItem => showLogToolStripMenuItem;
    public RichTextBox LogRichTextBox => richTextBoxLog;
    public SaveFileDialog SaveFileDialogLog => saveFileDialog1;
    #endregion
    ...
    private void cutoffToolStripMenuItem_Click(object sender, EventArgs e) => _controller.DisconnectSelectedClients();

    private void reconnectToolStripMenuItem_Click(object sender, EventArgs e) => _controller.ReconnectClients();
